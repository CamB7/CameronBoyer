...
while True:
    ...
    while True:
        print()
        PrevClaims = input("Do you have previous claims to enter? (Y/N): ").upper()
        if PrevClaims == "Y":
            while True:
                print()
            ...
            while True:
                try:
                    ...
                    print()
                    print("Input Error - Arrival date must be entered in the format YYYY-MM-DD.")
                    print()
                else: 
                    if ClaimDate > CUR_DATE:
                        print()
                        print("Input Error - Claim date must not be in the future.")
                        print()
                    else:
            ...
            while True:
                print()
                ClaimAmt = float(input("Enter the amount of the previous claim: "))
                if ClaimAmt == "":
                    print()
                    print("Input Error - Must be entered.")
                    print()
            ...
            # Create a dictionary for the previous claims and append to PrevClaimLst
            ClaimDict = {
                "Claim Number": ClaimNumLst[-1],
                "Claim Date": ClaimDateLst[-1],
                "Claim Amount": ClaimAmtLst[-1]
            }
            PrevClaimLst.append(ClaimDict)  
    ...
    if len(PrevClaimLst) > 0:
        for claim in PrevClaimLst:
            print(f"             {claim['Claim Number']:>5s}          {FV.FDateM(claim['Claim Date']):>10s}      {FV.FDollar2(claim['Claim Amount']):>10s}")
    else:
